      ...
      <div className="bg-white border-b-2 border-gray-200">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <button
            ...
            aria-label="Volver"
            className="flex-shrink-0 w-11 h-11 rounded-full border border-gray-300 bg-white text-gray-800 hover:bg-gray-50 flex items-center justify-center transition-colors"
          >
