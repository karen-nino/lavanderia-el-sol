      ...
      <div className="bg-white border-b-2 border-gray-200">
        <div className="px-6 md:px-8 pt-10 md:pt-14 pb-4 flex items-center gap-3">
          <button
            ...
            aria-label="Volver"
            className="w-11 h-11 rounded-full border border-gray-300 text-gray-700 flex items-center justify-center hover:bg-gray-50 transition-colors flex-shrink-0"
          >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
              <div className="px-5 py-4 border-b border-gray-100">
                <h2 className="text-sm font-semibold text-gray-800">Uso por día</h2>
              </div>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {data.dias.map((d) => (
                      <tr key={d.fecha} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2.5 text-right">{d.usos}</td>
                        ...
                        <td className="px-4 py-2.5 text-right">{d.empleados}</td>
