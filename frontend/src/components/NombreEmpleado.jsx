...
// Muestra "nombre apellido" completo y, solo si no cabe en el ancho disponible,
// corta el apellido a cinco letras (en vez de que baje de renglón o salga con
// "..."). Ej.: "Sofía Monrraz" → "Sofía Monrr.". Se mide con un nodo oculto que
...
export default function NombreEmpleado({ nombre, apellido, className = '' }) {
  ...
  return (
    <span className="relative block min-w-0">
      <span ref={visibleRef} className={`block truncate ${className}`}>
        {cortar ? corto : full}
      </span>
